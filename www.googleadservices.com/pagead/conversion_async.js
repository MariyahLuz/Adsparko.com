(function() {
    ...
    */
            ...
            if ((h = c.domain) && "auto" === h.toLowerCase()) {
                ...
                for (var k = 0; k < h.length; ++k) {
                    var m = "none" !== h[k] ? h[k] : void 0,
                        n = d(f, "domain", m);
                    n = e(n, c.flags);
                    if (!ac(m, c.path) && Wb(n, a, b, c.o)) break
                }
            } else h && "none" !== h.toLowerCase() && (f = d(f, "domain", h)), f = e(f, c.flags), ac(h, c.path) || Wb(f, a, b, c.o)
        }
    }
    ...
    function Cc(a, b, c, d) {
        ...
        if (d) return e;
        1 !== e[0] && (d = f[0], f = f[0].timestamp, b = [d.version, Math.round(f / 1E3), d.h].concat(d.labels || [], [b]).join("."), c = ec(c, f), c.o = "ad_storage", bc(a, b, c));
        return e
    }
    ...
    function kd(a, b, c, d, e, f) {
        ...
        id(d) && (g = d.l ? g + U("gbcov", 1) : g + U("gbcov", 0));
        return g
    }
    ...
    function Qd(a, b, c, d) {
        ...
        try {
            if (td(d)) {
                G && F(["466465925", "466465926"], Sa, 20);
                G && "466465926" == H(20) && Yc(a);
                ...
                !d.google_remarketing_only || d.google_conversion_domain || G && ("759248991" == H(14) || "759248990" == H(14)) ||
                    G && F(["759248990", "759248991"], Ta, 14);
                !1 !== d.google_conversion_linker && (d.google_gtm || Sc(d.google_gcl_cookie_prefix));
                if (1 == d.google_remarketing_only && null != d.google_gtag_event_data && null != d.google_gtag_event_data.items && d.google_gtag_event_data.items.constructor === Array && 0 < d.google_gtag_event_data.items.length) Rd(a, b, c, d);
                    ...
                    var g = !1;
                    r("www.googleadservices.com", "endsWith").call("www.googleadservices.com", "google.com") && (g = !0);
                    ...
                    d.google_remarketing_only ? h(2) : g ? (Pd(d, f ? 3 : 2), Id(c, d), h(1), h(3), f && h(6, !0, !1)) : (Pd(d, f ? 2 : 1), Id(c, d), h(0), f && h(5, !0, !1), id(d) && Rc(c, hd(d)) && (d.l = !0, h(0, !1)));
                    d.google_gtm_experiments && d.google_gtm_experiments.fledge && Kd(a, b, c, d)
                }
